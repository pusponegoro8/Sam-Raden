<div class="row mt-5">
    <div class="col-md-6 ml-auto mr-auto">
        <p class="row" style="text-align:justify; font-size: 20px;">
            ...
            Praktikum 2 ini merupakan praktikum matakuliah Client Side Programming yang membuat website berbasis
            modular dengan menggunakan Framework CSS Varian Bootstrap yaitu Atlantis Lite Master
        </p>
    </div>
</div>
<script>
