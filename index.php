                ...
                <div class="sidebar-content">
                    <ul class="nav nav-primary">
                        <li class="nav-item" id="mnhome">
                            <a href="home"><i class="icon-layers"></i><p>Beranda</p></a>
                        </li>
                        <li class="nav-item" id="mnform">
                            <a href="pasaran"><i class="icon-note"></i><p>Form</p></a>
                        </li>
                        <li class="nav-item" id="mnabout">
                            <a href="fr2"><i class="icon-tag"></i><p>Event</p></a>
                        </li>
                        <li class="nav-item" id="mnabout">
                            <a href="tentang"><i class="icon-tag"></i><p>Tentang</p></a>
                        </li>
                    </ul>
                </div>
            </div>
